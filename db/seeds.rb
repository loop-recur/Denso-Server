...
puts("Creating Hangman 4...")
App.create!(:name => "Hangman 4", :description => "The long awaited sequal to Hangman. Hangman 2.", :image => get_file["hangman2/image.png"], :package => get_file["hangman2/hangman2.zip"], :price => "1.99")
puts("Hangman 4 created.")