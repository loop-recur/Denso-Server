defn = function(fn) {
	...
	return function(){
		...
		return (args.length < arg_length) ? fn.p.apply(fn, args) : fn.apply(fn, args);
	}
}

var Functional={};
compose=function(){try{var fns=map(Function.toFunction,arguments)}catch(e){ throw("One of the arguments to compose() is not a function.") }; var arglen=fns.length;return function(){for(var i=arglen;--i>=0;)
...
arguments=[fns[i].apply(this,arguments)];return arguments[0];}}
map=defn(function(fn,sequence){fn=Function.toFunction(fn); if(!sequence) throw("map() was called without an array"); var len=sequence.length,result=new Array(len);for(var i=0;i<len;i++)
...
if(!(value=fn.call(null,sequence[i])))
break;return value;})
nnot=function(fn){fn=Function.toFunction(fn);return function(){return!fn.apply(null,arguments);}}
...
return fn.apply(this,args);};}
_=Function._={};Function.prototype.p=function(){var fn=this;var _=Function._;var args=Array.slice(arguments,0);var subpos=[],value;for(var i=0;i<arguments.length;i++)
...
if(specialized[i]==_)
return fn.p.apply(fn,specialized);return fn.apply(this,specialized);}}
